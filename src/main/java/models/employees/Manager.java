...
public class Manager extends Employee implements Searchable {
    ...
    public Manager(String ID, String name, String ICnum, String email, String phone) {
        this.ID = ID;
        this.name = name;
        this.ICnum = ICnum;
        this.email = email;
    ...
    public Boolean isFound(String searchText) {
        String Info =
                this.ID + " " + this.name + " " + this.ICnum + " " + this.email + " " + this.phone;
